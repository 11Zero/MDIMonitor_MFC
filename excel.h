...
/////////////////////////////////////////////////////////////////////////////
// _ApplicationE wrapper class

class _ApplicationE : public COleDispatchDriver
{
public:
	_ApplicationE() {}		// Calls COleDispatchDriver default constructor
	_ApplicationE(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ApplicationE(const _ApplicationE& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL GetIsSandboxed();
	BOOL GetSaveISO8601Dates();
	void SetSaveISO8601Dates(BOOL bNewValue);
