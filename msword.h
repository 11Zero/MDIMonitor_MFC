...
/////////////////////////////////////////////////////////////////////////////
// _ApplicationW wrapper class
#include <afxdisp.h>


class _ApplicationW : public COleDispatchDriver
{
public:
	_ApplicationW() {}		// Calls COleDispatchDriver default constructor
	_ApplicationW(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_ApplicationW(const _ApplicationW& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void PrintOut(VARIANT* Background, VARIANT* Append, VARIANT* RangeW, VARIANT* OutputFileName, VARIANT* From, VARIANT* To, VARIANT* Item, VARIANT* Copies, VARIANT* Pages, VARIANT* PageType, VARIANT* PrintToFile, VARIANT* Collate, 
...
public:
	...
	void Save();
	void SendMail();
	LPDISPATCH RangeW(VARIANT* Start, VARIANT* End);
	...
	void ExportAsFixedFormat(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, long RangeW, long From, long To, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, 
...
/////////////////////////////////////////////////////////////////////////////
// RangeW wrapper class

class RangeW : public COleDispatchDriver
{
public:
	RangeW() {}		// Calls COleDispatchDriver default constructor
	RangeW(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	RangeW(const RangeW& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL InStory(LPDISPATCH RangeW);
	BOOL InRange(LPDISPATCH RangeW);
	...
	void SortAscending();
	void SortDescending();
	BOOL IsEqual(LPDISPATCH RangeW);
	float Calculate();
	LPDISPATCH GoTo(VARIANT* What, VARIANT* Which, VARIANT* Count, VARIANT* Name);
...
public:
	...
	LPDISPATCH AddPicture(LPCTSTR FileName, VARIANT* LinkToFile, VARIANT* SaveWithDocument, VARIANT* RangeW);
	LPDISPATCH AddOLEObject(VARIANT* ClassType, VARIANT* FileName, VARIANT* LinkToFile, VARIANT* DisplayAsIcon, VARIANT* IconFileName, VARIANT* IconIndex, VARIANT* IconLabel, VARIANT* RangeW);
	LPDISPATCH AddOLEControl(VARIANT* ClassType, VARIANT* RangeW);
	LPDISPATCH New(LPDISPATCH RangeW);
	LPDISPATCH AddHorizontalLine(LPCTSTR FileName, VARIANT* RangeW);
	LPDISPATCH AddHorizontalLineStandard(VARIANT* RangeW);
	LPDISPATCH AddPictureBullet(LPCTSTR FileName, VARIANT* RangeW);
	LPDISPATCH AddChart(long Type, VARIANT* RangeW);
	LPDISPATCH AddSmartArt(LPDISPATCH Layout, VARIANT* RangeW);
};
/////////////////////////////////////////////////////////////////////////////
// _Font wrapper class
